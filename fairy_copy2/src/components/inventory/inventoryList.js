		...
		<table id="inventory" className="type09">
			<thead className="thead">
				<tr className="blue-text text-darken-2">
					<th className = "col s1 thead-th center" scope="cols" >ID</th>
					<th className = "col s2 thead-th center" scope="cols">품명</th>
					<th className = "col s2 thead-th center" scope="cols">획득일</th>
					<th className = "col s1 thead-th center" scope="cols">수량</th>
